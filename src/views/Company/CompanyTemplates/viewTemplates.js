...
import { BlockManager, BasicType, JsonToMjml, MjmlToJson } from 'easy-email-core';
import { EmailEditor, EmailEditorProvider, Stack } from 'easy-email-editor';
import { SimpleLayout, BlockAttributeConfigurationManager, BlockMaskWrapper } from 'easy-email-extensions';
        ...
        <div style={{ overflow: "scroll" }}>
            ...
            >
                {({ values }, { submit }) => {
                    return (
                        <>
                        {params.id=="new" ?  <PageHeader title='Create Template' /> : <PageHeader title='Preview Template' />}
                       <Row>
                            <Col md={6}>
